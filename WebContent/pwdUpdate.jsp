...
%><br><br><br>
<h1 align="center"><font><strong><U>Password Update<U></strong></font></h2>
<h7 align="center"><font color="red"><strong><%=request.getSession().getAttribute("sts")%></strong></font></h7>
<table align="center" cellpadding="5" cellspacing="5" border="1">
<tr>

</tr>
<form action="update_pwd.jsp" method="post">
<tr bgcolor="#A52A2A">
<td><b>Old Password</b></td><br>

<td><b>Update Password</b></td>
</tr>
<%
try{ 
...
%>
<tr bgcolor="#DEB887">
<td><input type="text" name="Password" value="<%=Password%>" readonly="readonly" disabled="disabled"/></td>
<td><input type="text" name="Password" value="<%=Password%>" maxlength="8"/></td>

</tr>

<tr ><td colspan="2" align="center"><input type="submit" name="Password" value="Submit" /></td>
</tr>
</form>
