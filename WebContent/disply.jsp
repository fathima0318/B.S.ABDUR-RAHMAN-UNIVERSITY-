...
<form action="disply_edit.jsp" method="post">
<h1 align="center"><font><strong><u>Profile</u></strong></font></h1>
<h7 align="center"><font color="red"><strong><%=request.getSession().getAttribute("sts")%></strong></font></h7>
...
%>
<tr><td bgcolor="#A52A2A" align="center"><b>First_Name</b></td><td bgcolor="#DEB887"><input type="text" name="First_Name" value="<%=firstname%>" disabled="disabled"/></td></tr>
<tr><td bgcolor="#A52A2A" align="center"><b>Last_Name</b></td><td bgcolor="#DEB887"><input type="text" name="Last_Name" value="<%=lstname%>" disabled="disabled"/></td></tr>
<tr><td bgcolor="#A52A2A" align="center"><b>EmailAddress</b></td><td bgcolor="#DEB887"><input type="text" name="EmailAddress" value="<%=email%>" disabled="disabled"/></td></tr>
<tr><td bgcolor="#A52A2A" align="center"><b>Age</b></td><td bgcolor="#DEB887"><input type="text" name="Age" value="<%=Age%>" disabled="disabled"/></td></tr> 
<tr><td bgcolor="#A52A2A" align="center"><b>Mobile</b></td><td bgcolor="#DEB887"><input type="text" name="Mobile" value="<%=Mobile%>" disabled="disabled"/></td></tr>
<tr><td bgcolor="#A52A2A" align="center"><b>City</b></td><td bgcolor="#DEB887"><input type="text" name="City" value="<%=City%>" disabled="disabled"/></td></tr>
<tr><td bgcolor="#A52A2A" align="center"><b>Zip_Code</b></td><td bgcolor="#DEB887"><input type="text" name="Zip_Code" value="<%=Zip_Code%>" disabled="disabled"/></td></tr>
